...
celebrity_16 = Celebrity.new(name: "David Guetta", category: "music", description: "David Guetta, né le 7 novembre 1967 à Paris, est un disc jockey, remixeur et producteur de musique français. Il débute adolescent avant de se professionnaliser juste avant la majorité.", price: "10000000")
...
celebrity_19 = Celebrity.new(name: "Jules César", category: "history", description: "Jules César, aussi appelé simplement César, est un général, homme politique et écrivain romain, né à Rome le 12 ou le 13 juillet 100 av. J.-C. et mort le 15 mars 44 av. J.-C. dans la même ville.", price: "10000000")
...
celebrity_23 = Celebrity.new(name: "Mark Grotjahn", category: "art", description: "Mark Grotjahn est un peintre américain surtout connu pour son travail abstrait et ses peintures géométriques audacieuses. Grotjahn vit et travaille à Los Angeles.", price: "10000000")
...
celebrity_24 = Celebrity.new(name: "Barbara Kruger", category: "art", description: "Barbara Kruger, née le 26 janvier 1945 à Newark aux États-Unis, est une artiste conceptuelle américaine. Elle vit entre New York et Los Angeles, où elle travaille également.", price: "10000000")
...
celebrity_25 = Celebrity.new(name: "Richard Hamilton", category: "art", description: "Richard Hamilton, né le 24 février 1922 à Pimlico et mort le 13 septembre 2011 à Londres, est un artiste peintre et graphiste britannique.", price: "10000000")
...
celebrity_28 = Celebrity.new(name: "Gordon Brown", category: "politic", description: "James Gordon Brown, né le 20 février 1951 à Giffnock en Écosse, est un homme d'État britannique, membre du Parti travailliste.", price: "10000000")
...
celebrity_31 = Celebrity.new(name: "Stefan Löfven", category: "politic", description: "Kjell Stefan Löfven est un homme d'État et syndicaliste suédois membre du Parti social-démocrate suédois des travailleurs, né le 21 juillet 1957 à Stockholm. Il est Premier ministre depuis 2014.", price: "10000000")
...
celebrity_34 = Celebrity.new(name: "Yukihiro Matsumoto", category: "technology", description: "Yukihiro Matsumoto, né le 14 avril 1965, est un informaticien japonais concepteur du langage de programmation Ruby. Il est couramment surnommé « Matz ». En mars 2012, il est honoré du prix du logiciel libre 2011 par la FSF et son président Richard Stallman à l’occasion de la conférence LibrePlanet 2012.", price: "10000000")
...
celebrity_36 = Celebrity.new(name: "Susan Wojciki", category: "technology", description: "Susan Wojcicki, née le 5 juillet 1968 dans le comté de Santa Clara en Californie, est une dirigeante d'entreprise américaine. Après avoir loué son garage aux cofondateurs de Google, elle est recrutée par l'entreprise en tant que directrice du marketing.", price: "10000000")
